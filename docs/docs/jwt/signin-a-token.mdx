...
import hsSrc from '!!raw-loader!/docs/jwt/src/hs-sign.js.source';
import rsSrc from '!!raw-loader!/docs/jwt/src/rs-sign.js.source';
import tokenSrc from '!!raw-loader!/docs/jwt/src/token.js.source';
...
<Translate id='jwt.signin.note-about-signin-jwt'>
...
<Tabs
  ...
  {algorithms.map((el, idx) => (
        ...
        <Translate id='jwt.signin.note-signin-jwt-example'>
            ...
            <br />
            <Translate id='jwt.signin.note-payload-jwt-headers'>
